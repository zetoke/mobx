...
export function generateComputedPropConfig(propName) {
    return (
        ...
        (computedPropertyConfigs[propName] = {
            configurable: globalState.enableStubbing, // See https://github.com/mobxjs/mobx/issues/1867, for computeds, we don't want reconfiguration, as this will potentially leak memory!
            enumerable: false,
            get() {
